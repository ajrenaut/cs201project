/* Enums are used in the place of integers throughout the program,
 * to handle switch and other conditional statements.
 */
...
enum { EMPTY = 0, VS_AI = 1, VS_PLAYER = 2,
       ...
       LEFT = 16, TOP_LEFT = 17, GAME_OVER = 18, GAME_TIED = 19};
